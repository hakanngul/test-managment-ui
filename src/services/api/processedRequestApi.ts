...
export const processedRequestApi = {
  ...
  getProcessedRequests: () => fetchData<ProcessedRequestSchema[]>('processedRequestsData'),

  // Get processed request by ID
  getProcessedRequestById: (id: string) => fetchData<ProcessedRequestSchema>(`processedRequestsData/${id}`),
  ...
  getProcessedRequestsData: () => fetchData<ProcessedRequestSchema[]>('processedRequestsData').catch(() => []),
};
