...
const initializeLauncher = async () => {
  try {
    ...
    // Temporarily disable agent auto-start for development
    logger.info('Agent auto-start is temporarily disabled');

    // Start auto-scaling if enabled (temporarily disabled)
