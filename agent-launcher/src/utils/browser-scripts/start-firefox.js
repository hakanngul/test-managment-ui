...
async function startBrowser() {
  try {
    console.log(`Starting Firefox browser on port ${port}, headless: ${headless}`);
    ...
    browser.on('disconnected', () => {
      console.log('Firefox browser disconnected');
      process.exit(0);
    });
    ...
    console.log('Firefox browser is ready');
  } catch (error) {
    console.error('Error starting Firefox browser:', error);
    process.exit(1);
  }
}
