...
async function startBrowser() {
  try {
    console.log(`Starting Chromium browser on port ${port}, headless: ${headless}`);
    ...
    console.log('Chromium browser is ready');
  } catch (error) {
    console.error('Error starting Chromium browser:', error);
    process.exit(1);
  }
}
